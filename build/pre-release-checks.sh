...
if [ $GRADLE_VERSION_COUNT_SPRING -ne "1" ];
then
    echo " *** Wrong version for fi.vincit:multi-user-test-runner-spring, found $GRADLE_VERSION_COUNT_SPRING"
    RETURN_VALUE=1
fi
