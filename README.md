...
```groovy
dependencies {
    test 'fi.vincit:multi-user-test-runner:0.4.0-RC2'
    // Spring support (optional)
    test 'fi.vincit:multi-user-test-runner-spring:0.4.0-RC2'
}
```
...
For all examples, please visit [multi-user-test-runner-examples](https://github.com/Vincit/multi-user-test-runner-examples/blob/0.4.0-RC2/README.md)
